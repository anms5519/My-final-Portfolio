            ...
            <div class="container">
                <h2 class="section-title" data-aos="fade-right">
                    ...
                    <span class="title-text"
                        >Work <span class="accent-text">Experience</span></span
                    >
                </h2>
                <p
                ...
                >
                    <div class="timeline-item">
                        <div class="timeline-dot">
                            ...
                            <span class="dot-tooltip">Design Experience</span>
                        </div>
                        <div class="timeline-content">
                            <div class="timeline-card">
                                <div class="timeline-header">
                                    <h3 class="job-title">
                                        Commercial Designer (Freelance)
                                    </h3>
                                    <span class="job-company">Fiverr</span>
                                ...
                                <div class="job-responsibilities">
                                    <ul>
                                        <li>
                                            Designed branding, advertisements,
                                            and marketing materials.
                                        </li>
                                        <li>
                                            Created logos, business cards,
                                            brochures, and packaging designs.
                                        </li>
                                        <li>
                                            Developed UI/UX designs for websites
                                            and mobile apps.
                                        </li>
                                        <li>
                                            Maintained a 5-star rating with high
                                            client satisfaction.
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="card-achievements">
                                    <span class="achievement"
                                        ><i class="fas fa-trophy"></i> 200+
                                        Projects Completed</span
                                    >
                                    <span class="achievement"
                                        ><i class="fas fa-star"></i> Maintained
                                        5-star Rating</span
                                    >
                                </div>
                    ...
                    <div class="timeline-item">
                        <div class="timeline-dot">
                            ...
                            <span class="dot-tooltip">Pharmacy Experience</span>
                        </div>
                        <div class="timeline-content">
                            <div class="timeline-card">
                                <div class="timeline-header">
                                    <h3 class="job-title">Retail Pharmacist</h3>
                                    <span class="job-company"
                                        >RANI MEDICAL CORNER, Dhaka</span
                                    >
                                    <span class="job-duration"
                                        >Jan 2012 – Present</span
                                    >
                                    <div class="experience-meter">
                                        <div
                                            class="meter-fill"
                                ...
                                <div class="card-achievements">
                                    <span class="achievement"
                                        ><i class="fas fa-users"></i> Served
                                        1000+ Customers</span
                                    >
                                    <span class="achievement"
                                        ><i class="fas fa-clipboard-check"></i>
                                        Expert Medication Management</span
                                    >
                                </div>
                                <div class="company-logo-3d">
                                    <div class="logo-cube">
                    ...
                    <div class="timeline-item">
                        <div class="timeline-dot">
                            ...
                            <span class="dot-tooltip">Data Analysis</span>
                        </div>
                        <div class="timeline-content">
                            <div class="timeline-card">
                                <div class="timeline-header">
                                    <h3 class="job-title">
                                        Data Visualization Specialist (Job
                                        Simulation)
                                    </h3>
                                    <span class="job-company"
                                        >Tata Consultancy Services</span
                                    >
                                    <span class="job-duration"
                                ...
                                <div class="job-responsibilities">
                                    <ul>
                                        ...
                                        <li>
                                            Utilized Python, Excel, and Power BI
                                            for data transformation.
                                        </li>
                                        <li>
                                            Applied statistical analysis and
                                ...
                                <div class="card-achievements">
                                    <span class="achievement"
                                        ...
                                        Created 5+ Interactive Dashboards</span
                                    >
                                    <span class="achievement"
                                        ><i class="fas fa-lightbulb"></i>
                                        Implemented Data-Driven Insights</span
                                    >
                                </div>
                                <div class="company-logo-3d">
                                    <div class="logo-cube">
                    ...
                    <div class="timeline-item">
                        <div class="timeline-dot">
                            ...
                            <span class="dot-tooltip">Security Experience</span>
                        </div>
                        <div class="timeline-content">
                            <div class="timeline-card">
                                <div class="timeline-header">
                                ...
                                <div class="job-responsibilities">
                                    <ul>
                                        ...
                                        <li>
                                            Analyzed network vulnerabilities and
                                            threat detection.
                                        </li>
                                        <li>
                                            Utilized cybersecurity tools for
                                ...
                                <div class="card-achievements">
                                    <span class="achievement"
                                        ><i class="fas fa-lock"></i> Implemented
                                        Security Protocols</span
                                    >
                                    <span class="achievement"
                                        ><i class="fas fa-search"></i> Detected
                                        & Mitigated Vulnerabilities</span
                                    >
                                </div>
                                <div class="company-logo-3d">
                                    <div class="logo-cube">
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content">
                            <div class="timeline-card">
                                <div class="timeline-header">
                                    <h3 class="job-title">
                                        WordPress Design & Developer Intern
                                    </h3>
                                    <span class="job-company"
                                        >Akbor Skills Development Limited</span
                                    >
                                    <span class="job-duration"
                                        >March 2025 – Present</span
                                    >
                                    <div class="experience-meter">
                                        <div
                                            class="meter-fill"
                                            style="width: 20%"
                                        ></div>
                                        <span class="meter-label">Recent</span>
                                    </div>
                                </div>
                                <div class="job-responsibilities">
                                    <ul>
                                        <li>
                                            Designing and developing custom
                                            WordPress websites.
                                        </li>
                                        <li>
                                            Implementing responsive designs and
                                            UI/UX improvements.
                                        </li>
                                        <li>
                                            Creating and customizing WordPress
                                            themes and plugins.
                                        </li>
                                        <li>
