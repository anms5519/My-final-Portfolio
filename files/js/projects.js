window.ProjectsContent = {
    ...
    init: function() {
        // Initialize projects section components
        this.setupProjects();
    ...
    setupProjects: function() {
        ...
        const projects = [
            {
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/TakaDenGoruNen.com', label: 'View Code' },
                    { type: 'live', url: 'https://takadengorunen.netlify.app/', label: 'Live Demo' }
                ],
            ...
            },
            {
                ...
                fullDescription: 'THETAEnhancer+ represents the next leap in image enhancement technology, leveraging state-of-the-art artificial intelligence to not only restore degraded images but also dramatically increase their quality and detail.',
                image: 'images/projects/ai-enhancer.jpg',
                category: 'ai',
                techs: ['deeplearning', 'computervision', 'imageprocessing', 'python'],
                type: 'ai',
                year: '2023',
                complexity: 'complex',
                features: [
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/THETAEnhancer-', label: 'View Code' },
                    { type: 'live', url: 'https://thetaenhancer.onrender.com', label: 'THETAEnhancer+' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                fullDescription: 'A collection of interactive web applications including HTML5 games, a CGPA calculator, and an academic report creator. These projects showcase front-end development skills with JavaScript, CSS, and modern web technologies.',
                ...
                links: [
                    { type: 'live', url: 'projects/html5.html', label: 'View Projects' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                fullDescription: 'A modern take on the classic brick-breaker game with realistic physics, special power-ups, and multiple levels of increasing difficulty.',
                ...
                links: [
                    { type: 'play', url: 'games/breakout.html', label: 'Play Game' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/RoboTheta', label: 'View Code' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/3d-fps-game', label: 'View Code' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/Dynamic-Web-Interfaces', label: 'View Code' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                fullDescription: 'An interactive data visualization platform infused with AI insights, turning complex datasets into intuitive, visually appealing graphics. This project empowers users to uncover hidden patterns and actionable intelligence effortlessly, making data analysis both engaging and insightful.',
                image: 'images/projects/datavizu.jpg',
                category: 'data',
                techs: ['datavisualization', 'aianalytics', 'interactivedesign', 'python', 'javascript'],
                type: 'data',
                year: '2023',
                complexity: 'complex',
                features: [
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/AI-Powered-Data-Visualizer', label: 'View Code' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                fullDescription: 'A fully immersive virtual tour created with Three.js and WebGL, designed to transport users into realistic 3D environments. Whether for real estate, education, or cultural exploration, this project offers an engaging and interactive way to experience spaces remotely.',
                image: 'images/projects/3d.jpg',
                category: 'web',
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/3d-tour', label: 'View Code' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                fullDescription: 'A sophisticated online game featuring advanced animations and responsive controls, crafted for real-time, competitive gameplay. This project promises smooth performance and immersive multiplayer experiences, ensuring every player feels fully engaged in the action.',
                image: 'images/projects/multiplayer.jpg',
                category: 'game',
                techs: ['websockets', 'gamedev', 'realtime', 'javascript', 'nodejs'],
                type: 'game',
                year: '2022',
                complexity: 'complex',
                features: [
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/multiplayer-game', label: 'View Code' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                fullDescription: 'A real-time simulation tool for quantum computing algorithms, featuring visually compelling representations of quantum mechanics. This project demystifies the complexities of quantum computation, making it accessible and engaging for enthusiasts and professionals alike.',
                image: 'images/projects/quantum.jpg',
                category: 'ai',
                techs: ['quantumcomputing', 'simulation', 'visualization', 'python'],
                type: 'ai',
                year: '2023',
                complexity: 'complex',
                features: [
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/Quantum-Code-Simulator', label: 'View Code' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                fullDescription: 'A deep learning project for recognizing handwritten digits',
                image: 'images/projects/handwritten.jpg',
                category: 'ai',
                techs: ['python', 'deeplearning', 'neuralnetworks', 'tensorflow', 'keras'],
                type: 'ai',
                year: '2023',
                complexity: 'complex',
                features: [
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/Handwritten-Digit-Recognizer', label: 'View Code' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                fullDescription: 'A machine learning project using KNN algorithm for breast cancer diagnosis',
                image: 'images/projects/knn.jpg',
                category: 'ai',
                techs: ['python', 'machinelearning', 'knn', 'jupyter', 'scikitlearn'],
                type: 'ai',
                year: '2023',
                complexity: 'complex',
                features: [
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/KNN---Breast-Cancer-Diagnosis', label: 'View Code' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                id: 'project14', // Duplicate of project12 based on content, but new entry in HTML
                title: 'Handwritten Digit Recognizer',
                description: 'Deep learning project for digit recognition',
                fullDescription: 'A deep learning project for recognizing handwritten digits',
                image: 'images/projects/handwritten.jpg',
            ...
            },
            {
                ...
                fullDescription: 'A machine learning project implementing the KNN algorithm',
                image: 'images/projects/knnclass.jpg',
                category: 'ai',
                techs: ['python', 'machinelearning', 'knn', 'classification', 'scikitlearn'],
                type: 'ai',
                year: '2023',
                complexity: 'complex',
                features: [
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/KNeighborsClassifier', label: 'View Code' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                fullDescription: 'A machine learning project for predicting plant diseases from leaf images',
                image: 'images/projects/plant.jpg',
                category: 'ai',
                techs: ['python', 'imageprocessing', 'agriculture', 'computervision', 'deeplearning'],
                type: 'ai',
                year: '2023',
                complexity: 'complex',
                features: [
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/Plant-Disease-Prediction-Using-Leaf', label: 'View Code' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                fullDescription: 'A machine learning project implementing the Decision Tree algorithm',
                image: 'images/projects/decision.jpg',
                category: 'ai',
                techs: ['python', 'machinelearning', 'decisiontrees', 'scikitlearn'],
                type: 'ai',
                year: '2023',
                complexity: 'complex',
                features: [
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/Decision-Tree-Classifier', label: 'View Code' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/Ultra-Advanced-Legendary-CSE-Toolkit-v4.2', label: 'View Code' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                fullDescription: 'Ultimate Academic Companion - Latest version of the CSE toolkit',
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/CSE-Toolkit-5.0-', label: 'View Code' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                category: 'ai',
                techs: ['python', 'deeplearning', 'computervision', 'tensorflow', 'keras'],
                type: 'ai',
                year: '2023',
                complexity: 'complex',
                features: [
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/Image-Classifier', label: 'View Code' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                fullDescription: 'A Deep Learning based project for stroke risk assessment',
                image: 'images/projects/strock.jpg',
                category: 'ai',
                techs: ['python', 'deeplearning', 'healthcare', 'tensorflow', 'keras'],
                type: 'ai',
                year: '2023',
                complexity: 'complex',
                features: [
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/Stroke-Risk-Assessment', label: 'View Code' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/portfolio-1', label: 'View Code' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/portfolio-2', label: 'View Code' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                fullDescription: 'A revolutionary neural network architecture that combines transformer models with reinforcement learning for unprecedented accuracy in natural language understanding and generation. The system can learn from minimal examples while maintaining contextual awareness across diverse domains.',
                image: 'images/projects/nural.jpg',
                category: 'ai',
                techs: ['neuralnetworks', 'naturallanguage', 'transformers', 'python', 'ai', 'reinforcementlearning'],
                type: 'ai',
                year: 'future',
                complexity: 'complex',
                features: [
            ...
            },
            {
                ...
                fullDescription: 'TaskFlow AI leverages machine learning to understand your work patterns, automatically suggesting task priorities, optimal work times, and potential scheduling conflicts. Built with React Native for cross-platform compatibility and Firebase for real-time sync.',
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/taskflow-ai-scheduler', label: 'View Code' },
                    { type: 'appstore', url: '#', label: 'View on App Store (iOS)' },
                    { type: 'googleplay', url: '#', label: 'View on Google Play' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                fullDescription: 'Discover hidden gems and happenings in your neighborhood. LocalVibe uses CoreML for personalized event recommendations and MapKit for seamless navigation. Features include event creation, RSVP tracking, and interest-based filtering. Native iOS development ensures optimal performance and integration.',
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/local-pulse-gather', label: 'View Code' },
                    { type: 'appstore', url: '#', label: 'View on App Store (iOS)' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                fullDescription: 'Achieve your fitness goals with FitForge Pro. Built using modern Android development practices with Kotlin and Jetpack Compose for a beautiful UI. Integrates with Health Connect for data sharing and offers a companion Wear OS app for tracking workouts on the go.',
                image: 'images/projects/fitforge.png',
                category: 'mobile',
                techs: ['kotlin', 'android', 'jetpackcompose', 'healthkit', 'wearos'],
                type: 'mobile',
                year: '2023',
                complexity: 'complex',
                features: [
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/forge-adaptive-fitness', label: 'View Code' },
                    { type: 'googleplay', url: '#', label: 'View on Google Play' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                fullDescription: 'Shop consciously with EcoThread. Built using Flutter for a single codebase targeting both iOS and Android. Features secure payments via Stripe integration, user reviews, brand filtering based on ethical certifications, and Firebase backend for product management.',
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/eco-thread-market', label: 'View Code' },
                    { type: 'appstore', url: '#', label: 'View on App Store (iOS)' },
                    { type: 'googleplay', url: '#', label: 'View on Google Play' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                fullDescription: 'Experience storytelling like never before. Point your device at designated markers or surfaces to watch characters and scenes emerge in AR. Built with Unity and C#, utilizing AR Foundation to support both ARKit (iOS) and ARCore (Android). Features interactive elements and engaging animations.',
                image: 'images/projects/storyscape.png',
                category: 'mobile',
                techs: ['unity', 'csharp', 'arfoundation', 'arkit', 'arcore', 'storytelling'],
                type: 'mobile',
                year: '2024',
                complexity: 'complex',
                features: [
                ...
                links: [
                    { type: 'github', url: 'https://github.com/anms5519/storyscape-ar-adventures', label: 'View Code' },
                    { type: 'appstore', url: '#', label: 'View on App Store (iOS)' },
                    { type: 'googleplay', url: '#', label: 'View on Google Play' }
                ],
                metrics: { stars: 0, forks: 0, watchers: 0 }
            },
            {
                ...
                fullDescription: 'Next-generation computer vision framework that can identify and track objects with exceptional precision in challenging environments including low light, high motion, and partial occlusion. Designed for real-time applications in autonomous systems and surveillance.',
                image: 'images/projects/visionx.jpg',
                category: 'ai',
                techs: ['computervision', 'objectdetection', 'realtime', 'python', 'ai'],
                type: 'ai',
                year: 'future',
                complexity: 'complex',
                features: [
            ...
            },
            {
                ...
                fullDescription: 'A groundbreaking UI/UX framework that adapts not only to screen sizes but to user behavior and preferences. FluidUI learns from interactions to create truly personalized interfaces while maintaining accessibility and performance across all devices.',
                image: 'images/projects/fuid.jpg',
                category: 'web',
                techs: ['ui', 'ux', 'responsive', 'adaptive', 'javascript', 'css', 'framework'],
                type: 'web',
                year: 'future',
                complexity: 'complex',
                features: [
            ...
            },
            {
                ...
                fullDescription: 'A revolutionary web platform that brings holographic-like 3D experiences to standard browsers without plugins. By leveraging WebGL, device sensors, and advanced rendering techniques, HoloWeb creates immersive spatial experiences for e-commerce, education, and entertainment.',
            ...
            },
            {
                ...
                fullDescription: 'An advanced predictive analytics platform that combines multiple forecasting methods with explainable AI. The system provides not only predictions but comprehensive explanations of factors influencing outcomes, making complex data analysis accessible to non-technical stakeholders.',
                image: 'images/projects/predictive.jpg',
                category: 'data',
                techs: ['predictiveanalytics', 'explainableai', 'forecasting', 'python', 'ai'],
                type: 'data',
                year: 'future',
                complexity: 'complex',
                features: [
            ...
            },
            {
                ...
                fullDescription: 'A comprehensive data integration and transformation platform designed to unify disparate data sources into coherent, analysis-ready datasets. DataNexus handles structured and unstructured data, automatically detecting relationships and suggesting optimal schema designs.',
                image: 'images/projects/datanexus.jpg',
                category: 'data',
                techs: ['dataintegration', 'etl', 'schemadesign', 'python', 'sql'],
                type: 'data',
                year: 'future',
                complexity: 'complex',
                features: [
            ...
            },
            {
                ...
                fullDescription: 'A next-generation blockchain protocol designed for enterprise supply chain verification and transparency. TrustChain provides tamper-proof documentation of product origins, manufacturing processes, and distribution while maintaining selective privacy for sensitive business information.',
            ...
            },
            {
                ...
                fullDescription: 'An innovative decentralized finance platform that enables cross-chain asset transfers, automated portfolio management, and programmable financial instruments. The platform is designed to be accessible to non-technical users while providing advanced functionality for institutional investors.',
                image: 'images/projects/dcfina.jpg',
                category: 'blockchain',
                techs: ['defi', 'crosschain', 'smartcontracts', 'solidity', 'blockchain'],
                type: 'blockchain',
                year: 'future',
                complexity: 'complex',
                features: [
            ...
            },
            {
                ...
                fullDescription: 'A groundbreaking VR game that simulates quantum physics phenomena in an engaging narrative adventure. Players navigate microscopic worlds where quantum mechanics govern gameplay, solving puzzles that require understanding principles like superposition and entanglement.',
                image: 'images/projects/quantum.jpg',
                category: 'game',
                techs: ['vr', 'physicssimulation', 'educational', 'unity', 'csharp', 'game'],
                type: 'game',
                year: 'future',
                complexity: 'complex',
                features: [
            ...
            },
            {
                ...
                fullDescription: 'An immersive ecological simulation game where players manage entire ecosystems with realistic biodiversity, climate, and resource dynamics. Player decisions have complex cascading effects throughout the environment, creating a deeply engaging system that reflects real-world ecological principles.',
                image: 'images/projects/ecospe.jpg',
                category: 'game',
                techs: ['simulation', 'ecosystem', 'aibehavior', 'unity', 'csharp', 'game'],
                type: 'game',
                year: 'future',
                complexity: 'complex',
                features: [
            ...
            },
            {
                ...
                fullDescription: 'A comprehensive developer productivity suite that combines AI-assisted coding, automated testing, and intelligent project management. DevForge analyzes codebases to detect patterns, suggest improvements, and automate repetitive tasks while maintaining code quality.',
                image: 'images/projects/devforge.jpg',
                category: 'tools',
                techs: ['developertools', 'aiassisted', 'automation', 'python', 'javascript'],
                type: 'tools',
                year: 'future',
                complexity: 'complex',
                features: [
            ...
            },
            {
                ...
                fullDescription: 'An advanced cybersecurity toolset for comprehensive security assessment and monitoring. SecurityVault combines penetration testing, vulnerability scanning, and real-time threat detection in a unified platform with intelligent risk prioritization and remediation suggestions.',
                image: 'images/projects/securityvault.jpg',
                category: 'tools',
                techs: ['cybersecurity', 'penetrationtesting', 'threatdetection', 'python', 'bash'],
                type: 'tools',
                year: 'future',
                complexity: 'complex',
                features: [
        ...
        projects.forEach(project => {
            ...
            gridCard.innerHTML = `
                    ...
                    <div class="card-overlay">
                        ...
                        <div class="card-quick-actions">
                            ...
                            ${project.links.map(link => `
                                <a href="${link.url}" target="_blank" class="quick-action-btn">
                                    <i class="fas ${link.type === 'github' ? 'fa-github' : 'fa-external-link-alt'}"></i>
                                </a>
                            `).join('')}
                        </div>
                    </div>
                ...
                <div class="card-content">
                    ...
                    <div class="card-meta">
                        <span class="meta-item"><i class="far fa-calendar-alt"></i> ${project.year}</span>
            ...
            listItem.innerHTML = `
                ...
                <div class="list-item-content">
                    ...
                    <div class="list-item-tags">
                        ${project.techs.slice(0, 5).map(tech => `<span class="list-tag">${tech}</span>`).join('')}
                    </div>
                    <div class="list-item-meta">
                        <span class="list-meta-item"><i class="far fa-calendar-alt"></i> ${project.year}</span>
                        <span class="list-meta-item"><i class="fas fa-tag"></i> ${project.type}</span>
                        <span class="list-meta-item"><i class="fas fa-code-branch"></i> ${project.metrics.forks}</span>
                        <span class="list-meta-item"><i class="fas fa-star"></i> ${project.metrics.stars}</span>
                    </div>
                </div>
                <div class="list-item-actions">
                    ...
                    ${project.links.map(link => `
                        <a href="${link.url}" target="_blank" class="list-action-btn">
                            <i class="fas ${link.type === 'github' ? 'fa-github' : 'fa-external-link-alt'}"></i>
                        </a>
                    `).join('')}
                </div>
        ...
        // Initialize carousel view with the same projects
    ...
    setupFilterFunctionality: function() {
        ...
        const filterProjects = () => {
            const projects = document.querySelectorAll('.project-card, .list-item');
            ...
            projects.forEach(project => {
                ...
                // Check if project matches all criteria
                ...
                const matchesCategory = document.querySelector('.project-filter.active').getAttribute('data-filter') === 'all' || 
                                   category === document.querySelector('.project-filter.active').getAttribute('data-filter');

                // Show or hide project based on filters
                if (matchesSearch && matchesTech && matchesType && matchesYear && matchesComplexity && matchesCategory) {
            ...
            resultsCount.textContent = `${halfCount} project${halfCount !== 1 ? 's' : ''} found`;
        ...
        [techFilter, typeFilter, yearFilter, complexityFilter].forEach(filter => {
        ...
        resetFilters.addEventListener('click', () => {
            ...
            const allFilterBtn = document.querySelector('.project-filter[data-filter="all"]');
        ...
        toggleFiltersBtn.addEventListener('click', () => {
            ...
            if (isExpanded) {
                ...
                filterControls.style.height = filterControls.scrollHeight + 'px';
    ...
    setupCarouselView: function(projects) {
        if (!projects) {
            // If projects not provided, extract from DOM
            ...
            projects = Array.from(projectCards).map(card => {
                return {
                    ...
                    links: Array.from(card.querySelectorAll('.quick-action-btn')).map(btn => {
                        if (btn.tagName === 'A') {
                            return {
                                type: btn.querySelector('i').classList.contains('fa-github') ? 'github' : 'live',
                                url: btn.href,
                                icon: btn.innerHTML
                            };
                        } else {
                ...
                <div class="carousel-item-inner quantum-glass">
                    ...
                    <div class="carousel-content">
                        ...
                        <div class="carousel-actions">
                            ...
                            ${project.links.filter(link => link.type !== 'details').map(link => `
                                <a href="${link.url}" target="_blank" class="carousel-action-btn">
                                    <i class="fas ${link.type === 'github' ? 'fa-github' : 'fa-external-link-alt'}"></i>
                                    <span>${link.type === 'github' ? 'Code' : 'Demo'}</span>
                                </a>
                            `).join('')}
                        </div>
                    </div>
    ...
    setupCarouselControls: function() {
        ...
        document.addEventListener('keydown', (e) => {
            if (document.querySelector('.projects-carousel-view').style.display !== 'none') {
        ...
        function handleSwipe() {
            ...
            // Left swipe
            if (touchEndX < touchStartX - threshold && currentIndex < indicators.length - 1) {
                currentIndex++;
                updateCarousel();
            }
    ...
    updateCarouselWithVisible: function() {
        ...
        this.setupCarouselView(visibleCards.map(card => {
            return {
                id: card.getAttribute('data-project-id'),
                title: card.querySelector('.card-title').textContent,
                description: card.querySelector('.card-description').textContent,
                image: card.querySelector('.card-image img').src,
                links: Array.from(card.querySelectorAll('.quick-action-btn, a')).map(btn => {
                    if (btn.tagName === 'A') {
                        return {
                            type: btn.querySelector('i').classList.contains('fa-github') ? 'github' : 'live',
                            url: btn.href,
    ...
    sortProjects: function(sortBy) {
        ...
        const sortProjects = (items) => {
            return items.sort((a, b) => {
                ...
                switch (sortBy) {
                    ...
                    case 'complexity':
                        return complexityRank[complexityB] - complexityRank[complexityA];
                    default:
                        return 0;
                }
            });
        ...
        // Sort and reappend to maintain order
    ...
    setupProjectModals: function() {
        ...
        const openProjectModal = (projectId) => {
            ...
            const description = projectCard.querySelector('.card-description').textContent;
            ...
            // Clear and fill features list (sample features)
            ...
            modalTechBadges.innerHTML = techs.map(tech => `
            ...
            const liveLink = projectCard.querySelector('a:not([href*="github"])');
    ...
    setupShareFunctionality: function() {
        ...
        const shareProjectImage = document.querySelector('.share-project-image');
        const shareProjectTitle = document.querySelector('.share-project-title');
        ...
        const shareProject = (projectId) => {
            ...
            // Generate share URL
            const shareUrl = window.location.href.split('#')[0] + '#projects-' + projectId;

            // Fill share modal with project data
            shareProjectImage.innerHTML = `<img src="${image}" alt="${title}" />`;
            shareProjectTitle.textContent = title;
            shareLink.value = shareUrl;

            // Generate QR code (placeholder - would need a QR code library)
        ...
        // Close share modal when clicking outside the content
        ...
        shareOptions.forEach(option => {
            option.addEventListener('click', () => {
                ...
                switch (platform) {
                    case 'twitter':
                        window.open(`https://twitter.com/intent/tweet?url=${encodeURIComponent(url)}&text=${encodeURIComponent('Check out this amazing project: ' + title)}`, '_blank');
                        break;
                    case 'linkedin':
                    ...
                    case 'facebook':
                        ...
                        break;
                    case 'email':
                        window.location.href = `mailto:?subject=${encodeURIComponent('Check out this project: ' + title)}&body=${encodeURIComponent('I thought you might be interested in this project: ' + title + '\n\n' + url)}`;
                        break;
                }
            });
        });
        ...
        downloadQrBtn.addEventListener('click', () => {
            // Alert placeholder - would need actual QR code generation
    ...
    show3DView: function() {
        ...
        // Create 3D view container if it doesn't exist yet
        ...
        document.querySelectorAll('.projects-grid-view, .projects-list-view, .projects-carousel-view, .projects-timeline-view')
            .forEach(view => view.style.display = 'none');

        // Show 3D view
        threeDView.style.display = 'block';
        
        // Scroll to make the 3D view visible
        setTimeout(() => {
    ...
    init3DShowcase: function() {
        // Create 3D view container if not exists
        if (!document.getElementById('projects-3d-view')) {
            ...
            threeDView.style.display = 'none'; // Initially hidden
            ...
            // Add quantum decorations for futuristic effect
            ...
            // Add the view to the projects section
    ...
    takeScreenshot: function() {
        if (!window.supremeProjectViewer || !window.supremeProjectViewer.renderer) return;
        
        // Create screenshot effect overlay
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                try {
                    ...
                    link.download = 'legendary-projects-3d-' + Date.now() + '.png';
    ...
    toggleFullscreen: function() {
        ...
        const button = document.querySelector('.scene-action-btn[data-action="fullscreen"] i');
    ...
    showNotification: function(message, type = 'info') {
        ...
        Object.assign(notification.style, {
            ...
            right: '20px',
            padding: '15px 20px',
            backgroundColor: type === 'success' ? 'rgba(0, 200, 83, 0.95)' : 
                            type === 'error' ? 'rgba(255, 50, 50, 0.95)' : 
    ...
    showProjects3D: function() {
        // Make sure 3D view container exists
        this.init3DShowcase();

        // Hide other views
        document.querySelector('.projects-grid-view').style.display = 'none';
        document.querySelector('.projects-list-view').style.display = 'none';
        document.querySelector('.projects-carousel-view').style.display = 'none';
        document.querySelector('.projects-timeline-view').style.display = 'none';
        ...
        viewButtons.forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                document.querySelectorAll('.projects-grid-view, .projects-list-view, .projects-carousel-view, .projects-timeline-view, .projects-3d-scene')
                    .forEach(view => view.style.display = 'none');
                ...
                if (viewType === '3d') {
                    ...
                    // Show 3D view and activate button
                    threeDView.style.display = 'block';
                    btn.classList.add('active');

                    // Initialize supreme 3D viewer
                    this.init3DViewer();
                } else if (viewType === 'timeline') {
                    // Show timeline view
                    document.querySelector('.projects-timeline-view').style.display = 'block';
                    btn.classList.add('active');
                } else if (viewType === 'grid') {
                    // Show grid view
                    document.querySelector('.projects-grid-view').style.display = 'block';
                    btn.classList.add('active');
                } else if (viewType === 'list') {
                    // Show list view
                    document.querySelector('.projects-list-view').style.display = 'block';
                    btn.classList.add('active');
                } else if (viewType === 'carousel') {
                    // Show carousel view
                    document.querySelector('.projects-carousel-view').style.display = 'block';
                    btn.classList.add('active');
                }
            });
        });
    ...
    init3DViewer: function() {
        ...
        // First, make sure TWEEN.js is loaded
        if (!window.TWEEN) {
        ...
        // When loading our project-3d-showcase.js, we'll handle the missing dependencies
        // with fallbacks in the file itself
        if (!window.supremeProjectViewer) {
            updateLoadingStatus('Loading 3D showcase components...', 30);
            
            // If script is not yet loaded, load it first
            ...
            script.onload = () => {
                ...
                if (window.supremeProjectViewer) {
                    try {
                        ...
                        this.showNotification('There was an issue loading the 3D view', 'error');
                    ...
                    console.error('supremeProjectViewer not defined after loading script');
            ...
            try {
                ...
                console.error('Error initializing 3D showcase:', error);
                this.showNotification('There was an issue with the 3D view', 'error');
